...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		healthBar.createFilledBar( // Custom color skins for each opponent
			switch(SONG.player2)
			{
				case 'dad' | 'mom-car' | 'parents-christmas': 0xFF5A07F5;
				case 'spooky': 0xFFF57E07;
				case 'monster-christmas' | 'monster': 0xFFF5DD07;
				case 'pico': 0xFF52B514;
				case 'senpai' | 'senpai-angry': 0xFFF76D6D;
		...
		var engineDisplay:String = 'Teeb Engine v${Main.gameVersion}';
