...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		super.create();
		new FlxTimer().start(1 / 30, function(tmr:FlxTimer)
		{
			startIntro();
		});
	}
	...
	function startIntro()
	{
		...
		credTextShit = new Alphabet(0, 0, "Zion\nTeebicus", true);
	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 1: createCoolText(['Zion', FlxG.random.bool(2) ? 'Teebiscuit' : 'Teebicus']);

			case 3: addMoreText('present');
			case 4: deleteCoolText();

			case 5: createCoolText(['Forever Engine', 'by']);
			case 7: addMoreText('Yoshubs');
